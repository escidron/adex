...
export default function PriceTypeSelector({ currentPriceType, handleCurrentPriceType }) {
    return (
        <div className=" mt-2 w-full flex gap-4">
            <div className={`w-full`}>
                <div className="flex gap-2">
                    ...
                    >
                        <p className={`flex items-center h-[20px] pr-1 text-[12px] md:text-[14px] lg:text-[16px]`}>Per month</p>
                    </div>
                    <div
                        type="text"
                        id="2"
                    ...
                    >
                        <p className={`flex items-center h-[20px] pr-1 text-[12px] md:text-[14px] lg:text-[16px]`}>Per unit</p>
                    </div>
                    ...
                    >
                        <p className={`flex items-center h-[20px] pr-1 text-[12px] md:text-[14px] lg:text-[16px]`}>One-time price</p>
                    </div>
                </div>
            </div>
        </div>
