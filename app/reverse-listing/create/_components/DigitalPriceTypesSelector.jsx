            ...
            <div className={`w-full`}>
                <div className="flex gap-2">
                    ...
                    <div
                        type="text"
                        id="3"
                        onClick={() => handleCurrentPriceType('3')}
                        className={` py-2  px-2 flex justify-between items-center cursor-pointer rounded-[50px] outline-none ${currentPriceType == '3' ? 'bg-[#FCD33B] text-black' : 'text-white bg-black'}    hover:text-black hover:bg-[#FCD33B] `}
                    >
