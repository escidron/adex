...
function Map({ newData,isDataLoaded }) {
  ...
  return isLoaded ? (
    ...
    <div className='w-full h-[100vh]'>
      <div className={`h-[100%] fixed  left-0 w-[60%]  ${newData.length>0?'overflow-y-scroll':''}`}>
          <MarketPlaceGrid newData = {newData} isDataLoaded={isDataLoaded}/>
      </div>

      <div className='h-[100%] fixed right-0  flex justify-center items-center w-[40%] mt-[45px]  '>
        <GoogleMap
