...
export default function FolderComponent() {
    ...
    return (
        ...
        <div className='flex justify-center bg-[#D9D9D9] h-[40px]'>
            <button onClick={()=>setFolder(1)} className={`border-l-[1px] border-r-[1px] ${folder===1?'bg-[#FCD33B]':'bg-white'}  px-[40px] text-[15px] ${inter.className} font-[600] flex items-center justify-center hover:bg-[#FCD33B]`}>Personal Information</button>
