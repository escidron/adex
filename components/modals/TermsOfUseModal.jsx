    ...
    return (
        <div className=' w-full h-full p-8 md:px-20 md:py-10'>
            ...
            <div className='flex items-start gap-4 mt-1'>
                ...
                <p>
                    You must be 18 years of age or older to have an account, or the age of majority in your state of residence.
                </p>
            </div>
            <div className='flex items-start gap-4 mt-1'>
                <p>
            ...
            <div className='flex items-start gap-4 mt-1'>
                ...
                <p>
                    If you make purchases, you will be asked to provide information about your Payment Instrument(s) which includes credit cards and debit cards.
                </p>
            </div>
            <div className='flex items-start gap-4 mt-1'>
                <p>
            ...
            <p className='mt-4'>
                Content that you post using our Service must be content you own or have the right to use such as usernames, business names, profile pictures, listing photos, listing descriptions, reviews, comments, videos, etc.).
            </p>
            <div className='flex items-start gap-4 mt-1'>
                <p>
                    •
            ...
            <div className='flex items-start gap-4 mt-1'>
                ...
                <h1 className='font-bold'>Reporting Infringing Content.
                    <span className='font-[400] ml-1'>
                        If Your Content infringes another person’s intellectual property, we will remove it upon receipt of a valid complaint.
                    </span>
                </h1>
            </div>
            <div className='flex items-start gap-4 mt-1'>
                ...
                <h1 className='font-bold'>Inappropriate, False or Misleading Content.
                    <span className='font-[400] ml-1'>
                        You agree that you will not post any content that is abusive, threatening (no hate speech), defamatory, obscene, vulgar (no profanity or pornographic content) or otherwise offensive or in violation of our policies or any part of our Terms. You also agree not to post any content that is false, misleading or uses the Service in a manner that is fraudulent or deceptive. ADEX and sellers reserves the right to decline Ads that do not meet these terms.
                    </span>
                </h1>
            </div>
            ...
            <h1 className='font-bold mt-4'>Sales Contract.
                <span className='font-[400] ml-1'>
                    A sales contract is established between the Seller and Buyer once the Buyer completes the steps for booking a listing.
                </span>
            </h1>
            ...
            <h1 className='font-bold mt-4'>Ratings.
                <span className='font-[400] ml-1'>
                    Once the transaction is complete, a rating shall be provided by the Buyer and the Seller.
                </span>
            </h1>

            <h1 className='font-bold mt-4'>Fees Generally</h1>
            ...
            <div className='flex items-start gap-4 mt-1'>
                ...
                <p>
                    If the booking is one month or less (or is an event/unit-based booking) – the entire sales amount (minus our 10% broker fee) is released to the seller’s ADEX wallet.
                </p>
            </div>
            <div className='flex items-start gap-4 mt-1'>
                <p>
                ...
                <p>
                    If the booking is longer than a month, the total sales/booking amount is prorated into monthly payments and charged on the first day of the booking period then on the 1st day of every month from there.
                </p>
            </div>
            <div className='flex items-start gap-4 mt-1'>
                <p>
                ...
                <p>
                    All fees associated with the sale will be provided on the sales receipt.
                </p>
            </div>

            <h1 className='font-bold mt-4'>5-Day Buyer Vetting period: Buyers have a 5-day vetting period.
                <span className='font-[400] ml-1'>
                    This will allow buyers time to obtain additional information from sellers (if needed) and for buyers to physically visit and inspect the location (if desired).                </span>
            </h1>

            <h1 className='font-bold mt-4'>Vetting, Cancellation & Disputes Between Users</h1>
            <p className='mt-4'>
            ...
            <h1 className='font-bold mt-4'>Disclaimer of Warranties.
                <span className='font-[400] ml-1'>
                    THE SERVICE AND ALL MATERIALS AND CONTENT AVAILABLE THROUGH THE SERVICE ARE PROVIDED &quot;AS IS&quot; AND ON AN &quot;AS AVAILABLE&quot; BASIS, WITHOUT WARRANTY OR CONDITION OF ANY KIND, EITHER EXPRESS OR IMPLIED. ADEX DISCLAIMS ALL WARRANTIES OF ANY KIND, WHETHER EXPRESS OR IMPLIED, RELATING TO THE SERVICE AND ALL MATERIALS AND CONTENT AVAILABLE THROUGH THE SERVICE, INCLUDING: (I) ANY IMPLIED WARRANTY OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE, QUIET ENJOYMENT, OR NON-INFRINGEMENT; AND (II) ANY WARRANTY ARISING OUT OF COURSE OF DEALING, USAGE, OR TRADE. NO ADVICE OR INFORMATION, WHETHER ORAL OR WRITTEN, OBTAINED BY YOU FROM THE SERVICE OR ANY MATERIALS OR CONTENT AVAILABLE THROUGH THE SERVICE WILL CREATE ANY WARRANTY THAT IS NOT EXPRESSLY STATED IN THESE TERMS. YOU ASSUME ALL RISK FOR ANY DAMAGE THAT MAY RESULT
                    FROM YOUR USE OF OR ACCESS TO THE SERVICE, YOUR DEALING WITH ANY OTHER SERVICE USER, AND ANY MATERIALS OR CONTENT AVAILABLE THROUGH THE SERVICE. YOU UNDERSTAND AND AGREE THAT YOU USE THE SERVICE, AND USE, ACCESS, DOWNLOAD, OR OTHERWISE OBTAIN MATERIALS OR CONTENT THROUGH THE SERVICE AND ANY ASSOCIATED SITES OR SERVICES, AT YOUR OWN DISCRETION AND RISK, AND THAT YOU ARE SOLELY RESPONSIBLE FOR ANY DAMAGE TO YOUR PROPERTY (INCLUDING YOUR COMPUTER SYSTEM OR MOBILE DEVICE USED IN CONNECTION WITH THE SERVICE), OR THE LOSS OF DATA THAT RESULTS FROM THE USE OF THE SERVICE OR THE DOWNLOAD OR USE OF THAT MATERIAL OR CONTENT. SOME JURISDICTIONS MAY PROHIBIT A DISCLAIMER OF WARRANTIES AND YOU MAY HAVE OTHER RIGHTS THAT VARY FROM JURISDICTION TO JURISDICTION. SOME JURISDICTIONS MAY PROHIBIT A DISCLAIMER OF WARRANTIES AND YOU MAY HAVE OTHER RIGHTS THAT VARY FROM JURISDICTION TO JURISDICTION.
                </span>
            </h1>

            <h1 className='font-bold mt-4'>Limitation of Liability.
                <span className='font-[400] ml-1'>
                    IN NO EVENT WILL ADEX BE LIABLE TO YOU FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL OR PUNITIVE DAMAGES (INCLUDING DAMAGES FOR LOSS OF PROFITS, GOODWILL, OR ANY OTHER INTANGIBLE LOSS) ARISING OUT OF OR RELATING TO YOUR ACCESS TO OR USE OF, OR YOUR INABILITY TO ACCESS OR USE, THE SERVICE OR ANY MATERIALS OR CONTENT AVAILABLE THROUGH THE SERVICE, WHETHER BASED ON WARRANTY, CONTRACT, TORT (INCLUDING NEGLIGENCE), STATUTE, OR ANY OTHER LEGAL THEORY, AND WHETHER OR NOT ADEX HAS BEEN INFORMED OF THE POSSIBILITY OF DAMAGE. EXCEPT AS EXPRESSLY PROVIDED IN THE FOLLOWING PARAGRAPH, YOU AGREE THAT THE AGGREGATE LIABILITY OF ADEX TO YOU FOR ALL CLAIMS ARISING OUT OF OR RELATING TO THE USE OF OR ANY INABILITY TO USE ANY PORTION OF THE SERVICE OR OTHERWISE UNDER THESE TERMS, WHETHER IN CONTRACT, TORT, OR OTHERWISE, IS LIMITED TO THE AMOUNT YOU HAVE PAID TO ADEX FOR ACCESS TO AND USE OF THE SERVICE IN THE 12 MONTHS PRIOR TO THE CLAIM. FOR ALL CLAIMS ARISING OUT OF OR RELATING TO TRANSFERS OF FUNDS FROM YOUR ADEX ACCOUNT BALANCE, THE SOLE REMEDY AGAINST ADEX SHALL BE LIMITED TO THE AMOUNT OF THE MONEY TO BE TRANSMITTED PLUS FEES AND CHARGES. IN EVENT SHALL ADEX BE LIABLE FOR DAMAGES FOR DELAY, NON DELIVERY, NONPAYMENT OR UNDERPAYMENT OF A PAYMENT TRANSACTION, WHETHER CAUSED BY AN ACT OR OMISSION OF ADEX OR OTHERWISE, OR INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL OR PUNITIVE DAMAGES, EXCEPT AS OTHERWISE PROVIDED BY APPLICABLE LAW OR REGULATION. ADEX SHALL HAVE NO LIABILITY FOR SUSPENDING OR TERMINATING YOUR ACCOUNT, RESTRICTING ACCESS TO YOUR ACCOUNT OR BALANCES IN YOUR ACCOUNT, OR SUSPENDING OR TERMINATING YOUR ACCESS TO THE SERVICE. ADEX SHALL NOT BE RESPONSIBLE FOR ANY SERVICE INTERRUPTIONS, INCLUDING, BUT NOT LIMITED TO, SYSTEM FAILURES OR OTHER INTERRUPTIONS THAT MAY AFFECT PURCHASES OR SALES, THE RECEIPT, PROCESSING, ACCEPTANCE, COMPLETION OR SETTLEMENT OF PAYMENT TRANSACTIONS, BANK DIRECT DEPOSIT TRANSFERS, OR THE SERVICE.
                    SOME JURISDICTIONS DO NOT ALLOW THE EXCLUSION OR LIMITATION OF LIABILITY FOR CONSEQUENTIAL OR INCIDENTAL DAMAGES. ACCORDINGLY, THE ABOVE LIMITATION MAY NOT APPLY TO YOU. EACH PROVISION OF THESE TERMS THAT PROVIDES FOR A LIMITATION OF LIABILITY, DISCLAIMER OF WARRANTIES, OR EXCLUSION OF DAMAGES IS TO ALLOCATE THE RISKS UNDER THESE TERMS BETWEEN THE PARTIES. THIS ALLOCATION IS AN ESSENTIAL ELEMENT OF THE BASIS OF THE BARGAIN BETWEEN THE PARTIES. EACH OF THESE PROVISIONS IS SEVERABLE AND INDEPENDENT OF ALL OTHER PROVISIONS OF THESE TERMS. THE LIMITATIONS APPLY EVEN IF ANY LIMITED REMEDY FAILS OF ITS ESSENTIAL PURPOSE.                </span>
            </h1>
            ...
            <h1 className='font-bold mt-4'>Miscellaneous</h1>
            <div className='flex items-start gap-4 mt-4'>
                <p>
                    •
                </p>
            ...
            <p className='mt-4'>
                YOU AND ADEX AGREE THAT EACH OF US MAY BRING CLAIMS AGAINST THE OTHER ONLY ON AN INDIVIDUAL BASIS AND NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY PURPORTED CLASS OR REPRESENTATIVE ACTION .9 ‘PROCEEDING. UNLESS BOTH YOU AND ADEX AGREE OTHERWISE, THE ARBITRATOR MAY NOT CONSOLIDATE OR JOIN MORE THAN ONE PERSON’S OR PARTY’S CLAIMS, AND MAY NOT OTHERWISE PRESIDE OVER ANY FORM OF A CONSOLIDATED, REPRESENTATIVE, OR CLASS PROCEEDING. ANY RELIEF AWARDED CANNOT AFFECT OTHER USERS.
            </p>

            <h1 className='font-bold mt-4'>Arbitration Procedures.
                <span className='font-[400] ml-1'>
                    The assigned independent arbitrator, and not any federal, state, or local court or agency, shall have exclusive authority to resolve any dispute arising out of or relating to
                    the interpretation, applicability, enforceability or formation of this or any other applicable Terms
                    or Policies, any part thereof, including, but not limited to, any claim that all or any part of these
                    Terms are void or voidable. All arbitration will be conducted by the American Arbitration
                    Association (&quot;AAA&quot;) under its rules and procedures, including the AAA’s Supplementary
            ...
            <h1 className='font-bold mt-4'>Severability.
                <span className='font-[400] ml-1'>
                    With the exception of any of the provisions in this Policy, if an arbitrator or court
                    decides that any part of this policy is invalid or unenforceable, the other parts of this Policy shall
                    still apply. If an arbitrator or court decides that any of the provisions in this Policy (&quot;Prohibition
                    of Class and Representative Actions and Non-Individualized Relief&quot;) is invalid or unenforceable,
                    then the entirety of this section shall be null and void.
                </span>
            </h1>

            <h1 className='font-bold mt-4'>Buyer/Seller Contract.
                <span className='font-[400] ml-1'>
                    When is booking is accepted/confirmed by the Seller, a contract is made between the buyer and
                    seller. Where applicable, the contract, buyer, and seller are bind by these terms and conditions.
                </span>
            </h1>
