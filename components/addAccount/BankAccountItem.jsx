    ...
    return (
        <div className={`border ${item.is_default == 1 ? 'border-black' : ''} flex justify-between items-center px-[30px] py-[15px] rounded-md max-w-[450px]`}>
            ...
            <div className='focus:outline-none'>
                <input onChange={(e) => handleSelected(e)} type="radio" value="" checked={item.is_default == 1 ? true : false} id={item.external_bank_account} className='text-black checked:text-black' />
            </div>
        </div>
    )
}
